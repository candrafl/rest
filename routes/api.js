...
// Apikey
var listkey = ["danzz","razanxx","9286c1a775","9267ic6a0f1","927j59de9c","921n567ea6","921h5a4282","925n2c494","928b0323c9","927b0k3hp7o2","925b04ib0j","023l1qhbpk","92b1a0h7ts","92a70b789c","9291a7bk0p1","92a7o8pe9c","92y1a7l0a6","9221a7i9h2","921a7k3n94","92a0kk2bc9","921a7l9pho2","92a2n1kb0j","92b0a75k6f","92u1a7pr8s"];
var listkeyprem = ["danzzprem","razanxx"];
var listkeyvip = ["danzzvip"];
...
router.get('/maker/nulis', async(req, res, next) => {
  ...
  if(listkey.includes(apikey)) {
  let result = `https://rya-kun.herokuapp.com/api/nulis?text=${text}`
  data = await fetch(result).then(v => v.buffer())
...
router.get('/islamic/kisahnabi', async (req, res, next) => {
	...
	let data = await fetchJson(`https://raw.githubusercontent.com/Danzzxcodes/scraper/main/islamic/kisah_nabi/${name}.json`)
	res.json({
	status: true,
	author: `${author}`,
	result: data
...
router.get('/islamic/quran', async (req, res, next) => {
	...
	let data = await fetchJson(`https://raw.githubusercontent.com/Danzzxcodes/scraper/main/islamic/quran.json`)
	res.json({
	status: true,
	author: `${author}`,
	result: data
...
router.get('/tools/fakeaddress', async (req, res, next) => {
	...
	let data = await fetchJson(`https://raw.githubusercontent.com/Danzzxcodes/scraper/main/tools/fake_address.json`)
	res.json({
	status: true,
	author: `${author}`,
	result: data
